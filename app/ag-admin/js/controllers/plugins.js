...
angular.module('base')
    .controller('pluginsController', function($scope, $http, notification, $state, $window) {
        $scope.languageArr = [];
    ...
    $scope.updatePluginStatus = function (e, plugin_name, status, hash) {
        ...
        if (confirm(confirm_msg)) {
            $http.put(admin_api_url + 'api/v1/settings/plugins', params).success(function (response) {
