(function (module) {
    ...
    module.controller('HeaderController', function (Common, Settings, $location, $scope, $rootScope, $state, TokenService, User, $uibModal, $timeout, Slug, isMobile, Language) {
        var model = this;
        model.loading = false;
        ...
        $scope.setActiveSearch = function (value) {
            $scope.activeSearch = value;
        };        
