(function(module) {
    ...
    module.controller('courseCategoryController', function(Course, Categories, AddFavourite, $scope, DeleteFavouriteByCourseId, $rootScope, $state, $uibModal) {
        var model = this;
        model.courses = [];
        model.categories = [];
        $scope.category = '';
    ...
    module.directive('creditCard', function() {
        return {
            ...
            restrict: 'A',
            link: function(scope, element, attrs) {
                $('.ZazpayCreditCardNumber').payment('formatCardNumber');
            }
        };
    });
