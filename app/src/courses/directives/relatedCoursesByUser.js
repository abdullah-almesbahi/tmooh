(function(module) {
    ...
    module.controller('relatedCoursesByUser', function(UserTeachingCourse, ViewCourse, $scope, $state, $uibModal, $rootScope, AddFavourite, DeleteFavouriteByCourseId) {
        var model = this;
        ...
        UserTeachingCourse.get({
            ...
            course_id: courseId,
            limit: limit,
            field: 'id,title,slug,user_id,displayname,price,image_hash,is_from_mooc_affiliate,course_image,user_image_hash,course_user_feedback_count,course_user_count,average_rating,currency_id,tier_id'
