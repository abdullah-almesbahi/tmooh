(function(module) {
    ...
    module.controller('wishlistController', function($state, Course, $scope, Wishlist, $rootScope, DeleteFavourite, $filter, TokenServiceData) {
        var model = this;
        $rootScope.pageTitle = $filter("translate")("My Wishlist Courses")+ " | " +$rootScope.settings['site.name'];
