...
(function(module) {
    ...
    var showing_limit = $rootScope.settings['facebook.default_limit_to_show_facebook_comment'];
		newUrl = '<div class="fb-comments" page-href=\"'+ currentURL +'\" data-width="500" data-numposts="'+ showing_limit +'"></div>';		
	...
	module.directive('fbComments', function($window, GENERAL_CONFIG, $rootScope, $compile) {
        ...
        restrict: 'C',
			link: function(scope, element, attributes) {					  
				...
				attributes.$observe('pageHref', function(newValue) {
					...
					newhtml = createHTML(href, numposts, width, colorscheme);
					compiledhtml = $compile(newhtml)(scope);
