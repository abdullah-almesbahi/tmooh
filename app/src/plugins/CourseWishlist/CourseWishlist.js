...
(function(module) {
    module.directive('courseWishlistData', function() {
        ...
        return {
            restrict: 'E',
            templateUrl: 'src/plugins/CourseWishlist/CourseWishlistByUser.tpl.html',
            link: linker,
    ...
    module.controller('CourseWishlistDataController', function($state, $scope, $rootScope, UserWishlist) {
        var model = this;
        params = {};
        userID = model.userId;
        model.loading = true;
...
(function(module) {
    module.directive('courseWishlist', function() {
        ...
        return {
            restrict: 'E',
            templateUrl: 'src/plugins/CourseWishlist/courseWishlist.tpl.html',
            link: linker,
    ...
    module.controller('WishlistController', function($scope, $state, $rootScope, AddFavourite, DeleteFavouriteByCourseId, $uibModal) {
        var model = this;
...
(function(module) {
    ...
    module.factory('UserWishlist', function($resource, GENERAL_CONFIG) {
        return $resource(
