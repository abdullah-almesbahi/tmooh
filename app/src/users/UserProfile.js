...
(function (module) {
    ...
    module.controller('UserController', function (UserDetail, $rootScope, UserLearning, UserTeaching, $scope, $location, $state, TokenService, $filter, TokenServiceData, ConstProfileSocialLink, InstructorStatsFactory, Slug) {
        ...
        getUserParams = {
            id: userID,
            field: 'id,biography,displayname,Headline,image_hash,is_teacher,course_user_count,course_favourites_count,designation,twitter_profile_link,google_plus_profile_link,facebook_profile_link,youtube_profile_link,website,linkedin_profile_link,active_course_count,experience,review_count'
        };
        params.id = userID;
                ...
                if (angular.isDefined(response.data)) {
                    if (response.data.length > 0) {
                        ...
                        if (model.user) {
                            ...
                            var des = $rootScope.metaDescription = model.user.biography == '' || model.user.biography == null ? model.user.designation : model.user.biography;
